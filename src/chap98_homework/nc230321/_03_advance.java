			...
			while(true) {
				...
				switch(input) {
					case 1 : 
						...
						bonus = sc.nextInt();
						ep[eno] = new RegularEmployee(eno, name, pay, bonus, input);
					...
					case 2 : 
						...
						hireYear = sc.nextInt();
						ep[eno] = new TempEmployee(eno, name, pay, hireYear, input);
						ep[eno].showEmployeeInfo();
						System.out.println("----------------");
						break;
					case 3 : 
						...
						workDay = sc.nextInt();
						ep[eno] = new ContractEmployee(eno, name, pay, workDay, input);
						ep[eno].showEmployeeInfo();
						System.out.println("----------------");
						break;
					case 4 : 
